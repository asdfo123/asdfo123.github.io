...
# 👋 About Me
 ...
 My research interests lie in Natural Language Processing (NLP) and Large Language Models (LLMs), with a particular focus on Model Editing (Knowledge Editing, KE), Knowledge, Reasoning and Debiasing techniques. More recently, I have developed a growing interest in Efficient Machine Learning (Efficient ML) and GUI Agents.
